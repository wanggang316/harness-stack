...
Save to `docs/exec-plans/<name>.md`. Follow the template at `skills/planner/references/exec-plan-template.md`.
...
With approved plan, proceed to `/harness-stack:exec-plan` for execution.
