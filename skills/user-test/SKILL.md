...
1. **User-test set** at `docs/user-tests/<feature>.md` — each case carries persona, preconditions, steps, assertions (observable-only), declared Evidence, and `Covers AC` mapping. See `skills/test-spec/`.
